...
For real fold/flip postures, split-screen divider changes, and independent iPad scenes, follow [adaptive-window-posture](../adaptive-window-posture/SKILL.md) instead of treating a compact screenshot as posture evidence.
