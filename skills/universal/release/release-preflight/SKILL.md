...
3. Review listing changes, screenshots/icons (size, alpha, locale), age rating, account/payment disclosures, support/privacy-policy URLs, permissions, store privacy answers, and Data safety where applicable against the actual app and SDK behavior. When iOS tracking is involved, use [att-review](../../../platform/ios/att-review/SKILL.md) for the privacy gate.
